                ...
                </div>
                {
                    isTimestampPickerOpen && (
                        <div className="absolute z-10 mt-2 top-full">
                            <TimestampPicker sourceDuration={displayedSources.find(s => s.is_checked)?.source_duration} start={start} setStart={setStart} end={end} setEnd={setEnd} confirmFn={confirmFn} rejectFn={rejectFn} />
                        </div>
                    )
                }
            </div>
