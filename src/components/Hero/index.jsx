        ...
        <div className="relative flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col items-center gap-5 z-1">
                ...
                <p className={`z-1 ${theme === "light"
                    ? "text-textColor-300"
                    : "text-white"
                    } text-center text-lg  w-[900px] max-w-[90vw] mx-auto`}>We&apos;re on a mission to revolutionize how organizations leverage their vast video and multimodal data, enabling powerful and engaging storytelling at scale.</p>

                <p className={`z-1 ${theme === "light"
                    ? "text-textColor-300"
                    : "text-white"
                    } text-center text-lg  w-[900px] max-w-[90vw] mx-auto`}>We&apos;re inviting select strategic partners to join us in this journey of discovery and transformation. Together, we can unlock new insights, drive innovation, and shape the future of enterprise data.</p>

                <p className={`z-1 ${theme === "light"
                    ? "text-textColor-300"
                    : "text-white"
                    } text-center text-lg  w-[900px] max-w-[90vw] mx-auto`}>Are you ready to make an impact? Let&apos;s connect.</p>
