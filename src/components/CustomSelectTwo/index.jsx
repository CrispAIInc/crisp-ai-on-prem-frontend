...
const CustomSelectTwo = ({ options, onChange, placeholder, dropdownText }) => {
    ...
    return (
        <div className="custom-select-container user-select-none">
            <select className={`px-1 cursor-pointer py-1 rounded-md outline-none ${theme === 'light' ? 'bg-light-hover-100/30 border border-textColor-100' : 'bg-light-hover-200/20 text-textColor-100  !border !border-textColor-300'}`} value={dropdownText}>
