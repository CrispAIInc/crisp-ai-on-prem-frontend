...
function SourceExplorerItem({
    ...
    return (
        <div
            className={`flex items-center gap-2 min-w-0 cursor-pointer rounded-xl p-1 bg-textColor-100/10 hover:bg-textColor-100/20 ${isSourceSelected && 'bg-textColor-100/30'}`}
