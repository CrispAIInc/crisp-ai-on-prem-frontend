...
${theme === 'light' ? 'hover:bg-textColor-100/20' : 'hover:bg-textColor-300/80'}`}>
            ...
            <div className={`absolute left-0 z-50 flex flex-col mt-2 overflow-x-hidden shadow-md w-fit rounded-2xl top-7 ${theme === "light" ? "border" : "!border !border-textColor-300"}`}>
                {
                    models.map((model) => (
                        <div
                            key={model.value}
