...
function StoryDetails() {
    ...
    // function to return all selectedStory content and outline as html
    function transformSelectedStoryToHtml(selectedStory) {
        if (!selectedStory) {
            return '';
        }

        const { content, outline } = selectedStory;

        const contentHtml = `<div class="content">${content}</div>`;
        const outlineHtml = `<div class="outline">${outline}</div>`;
