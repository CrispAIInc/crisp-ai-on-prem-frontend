...
export const useResizableSidebar = (minWidth, isLeft) => {
    ...
    const [sidebarWidth, setSidebarWidth] = useState(isMobile ? -100 : window.innerWidth / 4);
    ...
    const handleDoubleClick = () => {
        setSidebarWidth(isMobile ? -100 : window.innerWidth / 4);
    };
    ...
    return { sidebarWidth, setSidebarWidth, handleMouseDown, handleDoubleClick, maxWidth, isExpanded: sidebarWidth === window.innerWidth / 4 };
};
